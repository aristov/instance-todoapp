// import components
import Instance from 'instance/components/Instance';
import Button from 'instance/components/Button';
import TextBox from 'instance/components/TextBox';
import CheckBox from 'instance/components/CheckBox';
import Dialog from 'instance/components/Dialog';

// import template engine
import DOMTransform from 'DOMTransform';

// import templates
import button from 'instance/templates/button.js';
import textbox from 'instance/templates/textbox.js';
import checkbox from 'instance/templates/checkbox.js';
import dialog from 'instance/templates/dialog.js';

import { ENTER, ESCAPE, SPACE } from 'instance/tools/keyCodes';
...
class TodoApp extends Instance {
    constructor(element) {
        ...
        element.appendChild(domTransform.transform(this.load()));
    ...
    onSubmit(event) {
        ...
        if(text) {
            const element = domTransform.transform({ element : 'todoitem', text });
